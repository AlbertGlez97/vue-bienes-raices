...
watch(propiedad, (propiedad) => {
    ...
    direccion.value = `${propiedad.calle} ${propiedad.colonia} ${propiedad.ciudad}, ${propiedad.codigoPostal} ${propiedad.estado}, ${propiedad.pais}`;
})
...
<template>
    <v-card flat>
        <v-card-title class="mt-5 text-h3 text-center py-5 font-weight-bold text-pre-wrap">
            {{ propiedad?.titulo }}
        </v-card-title>
